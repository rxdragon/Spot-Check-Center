...
import { IDownLoadedList } from "~/types/shims-store"
import type { ActionTree, MutationTree } from 'vuex'
import type { State } from '../index'

const state: IDownLoadedList = {
  downloadList: []
}

const mutations: MutationTree<IDownLoadedList> = {
...
const actions: ActionTree<IDownLoadedList, State> = {
  // 增加列表
